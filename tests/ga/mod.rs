...
fn test_ga_start_maximize(){
    ...
    let configuration = GaConfiguration{
        ...
        limit_configuration: LimitConfiguration{max_generations: 100, fitness_target: None, problem_solving: ProblemSolving::Maximization, get_best_fitness_by_generation: None},
...
fn test_ga_run_minimize(){
    ...
    let configuration = GaConfiguration{
        number_of_threads: None,
        limit_configuration: LimitConfiguration{max_generations: 100, fitness_target: None, problem_solving: ProblemSolving::Minimization, get_best_fitness_by_generation: None},
        selection_configuration: None,
        crossover_configuration: None,
        selection: Selection::Random,
        crossover: Crossover::Cycle,
...
fn test_ga_run_multithread(){
    ...
    let configuration = GaConfiguration{
        ...
        limit_configuration: LimitConfiguration{max_generations: 1000, fitness_target: None, problem_solving: ProblemSolving::Maximization, get_best_fitness_by_generation: None},
