...
fn test_fitness_survivor_minization(){
    ...
    let population = fitness::fitness_based(population, 10,  ga::ProblemSolving::Minimization);
...
fn test_fitness_survivor_maximization(){
    ...
    let population = fitness::fitness_based(population, 10, ga::ProblemSolving::Maximization);
